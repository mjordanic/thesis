\chapter[Myoelectric patterns within the group of patients with iSCI]{Prediction of isometric motor tasks and effort levels based on high-density EMG in patients with incomplete spinal cord injury}
\label{ch:p2}
\textbf{Published as:} 
...
\begin{figure*}[htp!]
        ...
        \begin{subfigure}[b]{0.475\textwidth}
            \centering
            \includegraphics[width=\textwidth]{Images/figure2_5.png}
        ...
        \begin{subfigure}[b]{0.475\textwidth}  
            \centering 
            \includegraphics[width=\textwidth]{Images/figure2_6.png}
        ...
        \begin{subfigure}[b]{0.475\textwidth}   
            \centering 
            \includegraphics[width=\textwidth]{Images/figure2_7.png}
        ...
        \begin{subfigure}[b]{0.475\textwidth}   
            \centering 
            \includegraphics[width=\textwidth]{Images/figure2_8.png}
            \caption{LDA classification within a group of C4 patients using intensity and spatial features.}    
            \label{fig:2-8}
        \end{subfigure}
        \caption{Influence of the effort level on the task identification using LDA classifier.}
        \label{fig:2-5-27}
    \end{figure*}
